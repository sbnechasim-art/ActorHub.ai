...
async def lifespan(app: FastAPI):
    logger.info("Starting Delivery Service", version=settings.service_version)
    yield
    logger.info("Shutting down Delivery Service")


app = FastAPI(
    title="ActorHub Delivery Service",
    description="Content delivery and asset management",
